...
class Language {
  ...
  Language(this.id, this.name, this.languageCode, this.flag,
      this.fullLanguageCode, this.groupName);

  static List<Language> getLanguages() {
    return <Language>[
      Language(0, 'English (Default Language)', 'en', 'assets/flags/ic_us.png',
          'en-EN', 'langGroup'),
      Language(1, 'ગુજરાતી', 'gu', 'assets/flags/ic_india.png', 'gu-IN',
          'langGroup'),
      Language(
          2, 'हिन्दी', 'hi', 'assets/flags/ic_india.png', 'hi-IN', 'langGroup'),
      Language(3, 'عربي', 'ar', 'assets/flags/ic_ar.png', 'ar-AR', 'langGroup'),
      Language(4, 'français', 'fr', 'assets/flags/ic_french.png', 'fr-FR',
          'langGroup'),
    ];
  }
